...
import TargetRange from "../components/reportCost/TargetRange.js";
import Duplicate from "../components/duplicate/Duplicate.js";
...
const targetRange = new TargetRange();
...
export const tabTarget = [
  ...
  { title: "Khoảng ngày", link: "[Target] rangeDate", component: targetRange }
];
