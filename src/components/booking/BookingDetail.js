...
class BookingDetail {
  constructor({ closeBookingDetail, data }) {
    ...
    this.$infoTitle.className =
      "bg-light fs-6 px-3 py-1 mb-3 d-flex align-items-center gap-2";
    ...
    this.$phonenumber1 = new BookingDetailItem({
      title: "Điện thoại 1",
      value: data.phone_1
    });
    this.$phonenumber2 = new BookingDetailItem({
      title: "Điện thoại 2",
      value: data.phone_2
    });
    ...
    this.$bookingCode = new BookingDetailItem({
      title: "Mã booking",
      value: data.code_booking
    });
    ...
    this.$prepayment = new BookingDetailItem({
      ...
      value: `${formatNumber(data.tien_truoc_giam)} đ`
    });
    this.$receivable = new BookingDetailItem({
      title: "Tiền phải thu",
      value: `${formatNumber(data.tien_phai_thu)} đ`
    });
    this.$received = new BookingDetailItem({
      title: "Tiền đã thu",
      value: `${formatNumber(data.tien_da_thu)} đ`
    });

    this.$brand = new BookingDetailItem({
      title: "Thương hiệu",
      value: data.brand
    });
