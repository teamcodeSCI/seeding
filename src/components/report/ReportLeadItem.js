...
class ReportLeadItem {
    constructor({ title, today, part, desc }) {
        this.today = today || 0
        this.part = part || 0
        ...
        this.$span.innerHTML = formatNumber(today)
        ...
        this.$part.innerHTML = `${desc}: ${formatNumber(part)}`
