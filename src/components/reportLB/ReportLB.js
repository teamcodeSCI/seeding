...
class ReportLB {
    constructor() {
        ...
        this.$titleLB.innerHTML = 'Số lượng lead/booking:'
    ...
    getLayoutLB = () => {
        ...
        this.$menuLB = new Tabs({ getLayout: this.getLayoutLB, tab: 'tabLB', tabs: tabLead })
    ...
    getLayoutSuccess = () => {
        ...
        this.$menuSuccess = new Tabs({ getLayout: this.getLayoutSuccess, tab: 'tabSuccess', tabs: tabSuccess })
