...
class ReportCostYear {
    ...
    dataSet = [{
        ...
        data: [300000, 500000, 3000000, 2000000, 2000000, 1000000, 700000, 3000000, 2000000, 2000000, 1000000, 700000]
    }, {
        label: 'Doanh thu',
        ...
        data: [1000000, 1500000, 5000000, 4000000, 6000000, 3000000, 2000000, 5000000, 4000000, 6000000, 3000000, 2000000]
    }, {
        label: 'Còn nợ',
        backgroundColor: 'red',
        borderColor: 'red',
        highlightFill: 'red',
        highlightStroke: 'red',
        data: [700000, 1000000, 2000000, 2000000, 4000000, 2000000, 1300000, 2000000, 2000000, 4000000, 2000000, 1300000]
    }]
    branchData = [{
        name: 'Paris',
        revenue: '1000000',
    ...
    renderCardItem = () => {
        ...
        for (let item of this.data) {
            this.$cardItem = new ReportCard({ title: item.title, today: item.now, desc: 'Năm trước', part: item.part, isMoney: true })
